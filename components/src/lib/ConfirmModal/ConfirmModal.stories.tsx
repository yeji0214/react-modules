...
const meta = {
  ...
  argTypes: {
    ...
    caption: { description: 'ConfirmModal의 설명' },
  },
  args: {
    isOpen: true,
    onToggle: fn(),
...
export const LargeCentered: Story = {
  parameters: {
    docs: {
      description: {
        story: 'ConfirmModal의 size가 large이고 position이 center일 때',
      },
    },
  },
  args: {
...
export const MediumCentered: Story = {
  parameters: {
    docs: {
      description: {
        story: 'ConfirmModal의 size가 Medium이고 position이 center일 때',
      },
    },
  },
  args: {
...
export const SmallCentered: Story = {
  parameters: {
    docs: {
      description: {
        story: 'ConfirmModal의 size가 Small이고 position이 center일 때',
      },
    },
  },
  args: {
...
export const LargeBottomed: Story = {
  parameters: {
    docs: {
      description: {
        story: 'ConfirmModal의 size가 large이고 position이 bottom 때',
      },
    },
  },
  args: {
...
export const MediumBottomed: Story = {
  parameters: {
    docs: {
      description: {
        story: 'ConfirmModal의 size가 medium이고 position이 bottom 때',
      },
    },
  },
  args: {
...
export const SmallBottomed: Story = {
  parameters: {
    docs: {
      description: {
        story: 'ConfirmModal의 size가 small이고 position이 bottom 때',
      },
    },
  },
  args: {
